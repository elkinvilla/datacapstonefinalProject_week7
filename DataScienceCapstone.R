mergeFiles <- function() {
        # if (!file.exists("C:/Personal/coursera-data-science/10-Data-Science-Capstone/Coursera-SwiftKey/en_US/mergedfile.txt")) {
        conn <- file("C:/Personal/coursera-data-science/10-Data-Science-Capstone/Coursera-SwiftKey/en_US/mergedfile.txt", "r")
        fulltext <- readLines(conn, encoding = "UTF-8", skipNul = TRUE)
        nlines <- length(fulltext)
        close(conn)

        conn <- file("C:/Personal/coursera-data-science/10-Data-Science-Capstone/Coursera-SwiftKey/en_US/sampledfile.txt", "w")
        ...
        paste(
                ...
                sum(selection),
                "lines to file",
                "C:/Personal/coursera-data-science/10-Data-Science-Capstone/Coursera-SwiftKey/en_US/sampledfile.txt"
        )
        # }
}
...
makeCorpus <- function() {
        mytf3 <-
                readLines("C:/Personal/coursera-data-science/10-Data-Science-Capstone/Coursera-SwiftKey/en_US/sampledfile.txt",
